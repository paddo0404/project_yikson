      ...
      <div class="breadcrumbs" id="breadcrumbs"> 
        ...
        <ul class="breadcrumb">
         	<li>
							...
							<li class="active"><a href="<?=site_url("administrator/categories")?>">Manage Category List</a></li>
			 ...
			 if(isset($_GET['fsuccess'])) { ?>		
                      <div class="alert alert-block alert-success">  <p>
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
<form action="<?=site_url('administrator/add_edit_category')?>" method="post" id="frmCreateListing" name="frmCreateListing" class="form-horizontal" onSubmit="return validate();" enctype="multipart/form-data" > 
       <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Category name: </label>
                
                <div class="col-sm-9">
                
                <input id="focusedInput" class="col-xs-10 col-sm-5"  name="name" type="text" value="<?=$get_data['0']->cname?>">
                </div>
                </div>
                ...
                Reset
                </button>  <input name="hdn_id" type="hidden" value="<?php echo $get_data['0']->cid?>">
                </div>
                </div>
