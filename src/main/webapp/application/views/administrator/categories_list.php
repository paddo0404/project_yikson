  ...
  <div class="main-container-inner"> <a class="menu-toggler" id="menu-toggler" href="#"> 
    ...
    <div class="main-content"> 
      ...
      <div class="page-content"> 
        ...
        <table><tr><td width="1280px" class="table"><h1> Categories List </h1></td><td align="right">
        <a href="<?php echo site_url('administrator/new_category');?>" class="btn  btn-primary">Add New Category</a>
                ...
                <div class="table-responsive"> 
                  <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr> 
						<td><?=$ii?></td>
						<td><?=stripslashes($all_category[$i]->cname)?></td>
						<td><?=stripslashes($all_category[$i]->status)?></td>
						<td><?=$all_category[$i]->createdon?></td>
						
						<td> <a class="green"  href="<?=site_url("administrator/new_category")."/".$all_category[$i]->cid?>"> <i class="icon-pencil bigger-130"></i> 
						</a> 
						
						<a class="red" href="#" onClick="var q = confirm('Are you sure you want to delete this category?'); if (q) { window.location = '<?=site_url("administrator/delete_category")?>?action=delete&id=<?php echo $all_category[$i]->cid;?>'; return false;}"> <i class="icon-trash bigger-130"></i> 
						</a></td>
