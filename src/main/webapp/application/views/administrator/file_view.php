...
<hr><hr id="line"> 
	<div id="selectImage">
		...
		<form action="http://localhost/projects/ci_image_upload_download/index.php/administrator/do_upload" method="post" accept-charset="utf-8" enctype="multipart/form-data"> 
