					...
					<div class="container">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
							<ul class="nav nav-tabs img_tabs" role="tablist">
								<li role="presentation" class="active"><a href="#home1" aria-controls="home1" role="tab" data-toggle="tab">IMAGES</a></li>
								<li role="presentation"><a href="#profile1" aria-controls="profile1" role="tab" data-toggle="tab">GIFS</a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-3 col-xs-11 col-sm-4 col-md-3 mbl_mrg_tp">
						<div class="row">
							<div class="multi_img">
								...
								<a href="" class="title_tag"><?php echo $all_posts[$ij]['title'];?></a>
								<div class="row">
									<div class="col-lg-6 pull-left">
										<span class="font_9 black"><?php echo $user_data['0']->full_name;?></span>
									</div>
									<div class="col-lg-6 pull-right"> 
										<span class=" pull-right font_9 black"><?php echo $all_posts[$ij]['post_view'];?> &nbsp;<img src="<?php echo base_url(); ?>assets/front/images//page_2/view_small.png"></span>
									</div>
								</div>
							</div>
						</div>
