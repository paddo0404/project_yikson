			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="row">
					<div class="col-lg-7 col-lg-offset-2 col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
							...
							<div class="col-lg-12 col-md-12  col-sm-12 col-xs-12 secnd_main2 mrg_tp5_px">
								<div class="row">
									<ul class=" profile_option">
										...
										<li  class="active"><a href="<?php echo site_url('profile_pictures/'.$user_data['0']->mid); ?>" class="return_pic"></a></li>
					 ...
					 if(count($all_images)>0){ for($i=0;$i<count($all_images);$i++){
					  ?>
					
						 <div class='col-sm-4' style='padding:10px;height:200px;border:1px solid grey;margin-top:10px;'>
							<center><img class="img-responsive" alt="" src="<?php echo base_url(); ?>assets/uploads/posts/<?php echo $all_images[$i]->file_name; ?>"></center>
						 </div>
						  
					<?php } }else{ ?>
						<div class="error">No Images details available</div>
					<?php } ?>
