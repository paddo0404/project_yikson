						...
						<div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
							<div class="row">
								<ul class="menu_list">
									...
									<li class="postwidth" style="vertical-align:middle !important;"><div ><a href="" class="font_16 postwidth"><?php echo $user_data['0']->full_name;?> </a></div><div style='clear:both;'></div>
